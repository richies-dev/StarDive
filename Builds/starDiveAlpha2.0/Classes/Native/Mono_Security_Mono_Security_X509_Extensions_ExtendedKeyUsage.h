...
struct  ExtendedKeyUsageExtension_t1238  : public X509Extension_t1043
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t973 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1238_StaticFields{
	...
	Dictionary_2_t671 * ___U3CU3Ef__switch$map14_4;
};
