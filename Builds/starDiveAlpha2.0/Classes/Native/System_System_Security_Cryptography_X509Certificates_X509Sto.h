...
struct  X509Store_t1041  : public Object_t
{
	...
	X509Certificate2Collection_t1031 * ___list_2;
	...
	X509Store_t1057 * ___store_4;
};
struct X509Store_t1041_StaticFields{
	...
	Dictionary_2_t671 * ___U3CU3Ef__switch$mapF_5;
};
