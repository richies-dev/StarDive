...
struct  ServicePointManager_t941  : public Object_t
{
};
struct ServicePointManager_t941_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t895 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t926 * ___server_cert_cb_9;
};
