...
// ShopItem
struct  ShopItem_t94  : public Object_t
{
	...
	Texture_t12 * ___ItemTexturePurchased_3;
	// UnityEngine.Texture ShopItem::ItemTextureNotPurchased
	Texture_t12 * ___ItemTextureNotPurchased_4;
	// UnityEngine.GUITexture ShopItem::GuiTextureStored
	GUITexture_t121 * ___GuiTextureStored_5;
	// UnityEngine.GUIText ShopItem::GuiTextStored
	GUIText_t91 * ___GuiTextStored_6;
	...
	Vector2_t16  ___StartPositionTexture_9;
	// UnityEngine.Vector2 ShopItem::StartPositionText
	Vector2_t16  ___StartPositionText_10;
