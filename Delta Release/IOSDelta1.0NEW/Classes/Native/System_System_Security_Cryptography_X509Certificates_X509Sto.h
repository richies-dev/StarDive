...
struct  X509Store_t974  : public Object_t
{
	...
	X509Certificate2Collection_t964 * ___list_2;
	...
	X509Store_t990 * ___store_4;
};
struct X509Store_t974_StaticFields{
	...
	Dictionary_2_t600 * ___U3CU3Ef__switch$mapF_5;
};
