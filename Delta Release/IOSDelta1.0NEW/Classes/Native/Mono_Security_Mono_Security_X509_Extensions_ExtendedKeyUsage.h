...
struct  ExtendedKeyUsageExtension_t1171  : public X509Extension_t976
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t906 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1171_StaticFields{
	...
	Dictionary_2_t600 * ___U3CU3Ef__switch$map14_4;
};
