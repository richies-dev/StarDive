...
struct  CanvasListPool_t393  : public Object_t
{
};
struct CanvasListPool_t393_StaticFields{
	...
	ObjectPool_1_t391 * ___s_CanvasListPool_0;
	...
	UnityAction_1_t392 * ___U3CU3Ef__am$cache1_1;
};
